...
<body class="bg-gray-900 text-white min-h-screen flex items-center justify-center">
    <div class="max-w-md w-full bg-gray-800 rounded-lg shadow-md p-8 space-y-4">
        <h2 class="text-3xl font-semibold text-center text-gray-200">Register</h2>
        <form class="space-y-4" method="POST" action="/server/process.php?type=register">
            <div>
            ...
            <div>
                <label for="password2" class="block text-sm font-medium">Password</label>
                <input type="password2" class="border border-indigo-500 rounded-md py-2 px-3 w-full focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 bg-gray-700 text-white" id="password2" name="password2" required>
            </div>
